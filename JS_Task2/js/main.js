...
imgHermione.style.height = "100px";
imgHermione.style.width = "100px";
imgHermione.style.objectFit = "cover";
...
imgHarry.style.height = "100px";
imgHarry.style.width = "100px";
imgHarry.style.objectFit = "cover";
imgHarry.style.borderRadius = "40%";
...
imgRon.style.height = "100px";
imgRon.style.width = "100px";
imgRon.style.objectFit = "cover";
